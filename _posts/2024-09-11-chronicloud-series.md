...
1. **Azure Local**  
Azure Local is a hyper-converged infrastructure solution from Microsoft that enables organizations to run virtualized workloads on-premises, with integration to Azure. This has become the most mature part of the Chronicloud Series so far and several articles are already available:
   ...
   - *Awesome Azure Local*: A curated catalog of Azure Local, AVD, AKS, official documentation and community resources. For more details, see [Awesome Azure Local](/blog/awesome-azure-local/).
...
2. **Azure Virtual Desktop (AVD)**  
   AVD offers a virtualized desktop experience in the cloud, enabling secure remote work. The Azure Local track already includes a first article on [Azure Local: Azure Virtual Desktop](/blog/azure-stack-hci-azure-virtual-desktop/) and I will keep expanding the broader AVD topic as part of the Chronicloud roadmap. In this series, I’ll explore:
...
3. **Azure Arc**
   Azure Arc is a tool that extends Azure management and services to any infrastructure, on-premises or multi-cloud. Arc already appears throughout the Azure Local articles, especially in VM management, AKS, monitoring and Terraform automation and I will treat it as its own topic within the series. This part of the series will discuss:
...
4. **Cloud PC**  
   Cloud PC, powered by Windows 365, provides a full desktop experience in the cloud. I will start treating Cloud PC as part of the Chronicloud roadmap, connecting it with the AVD and end-user computing content. I’ll walk you through:
...
5. **Cloud Adoption Framework (CAF)**  
   The *Cloud Adoption Framework* provides a structured approach to cloud migration and management. I will also cover CAF as the architecture and governance layer that connects the technical guides with real adoption work. This series will focus on:
...
In upcoming posts, I will continue breaking down these topics into separate series with links available directly from this page. Azure Local already has a strong set of published articles and the next wave of Chronicloud content will keep expanding AVD, Azure Arc, Cloud PC and CAF throughout 2026 and 2027. This post will act as the **main guide** for the **Chronicloud Series** and each linked series will serve as a deep dive into the individual technologies. Stay tuned for more detailed guides, resources and real-world labs!
